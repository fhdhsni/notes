...
* User stuff
- from https://askubuntu.com/a/410274/221624
- To list all local users you can use:
  + ~cut -d: -f1 /etc/passwd~
- To list all users capable of authenticating (in some way), including
  non-local, see this reply: https://askubuntu.com/a/414561/571941
